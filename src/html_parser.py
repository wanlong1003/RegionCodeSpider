...
class HtmlParser(object):
    ...
    def village_parser(self, html_content, url):
        ...
        urls = [(tr.contents[2].get_text() if tr.contents[2].a is None else tr.contents[2].a.get_text(),
                 tr.contents[0].get_text() if tr.contents[0].a is None else tr.contents[0].a.get_text(),
                 tr.contents[1].get_text() if tr.contents[1].a is None else tr.contents[1].a.get_text())
                for tr in url_trs]
        return urls
